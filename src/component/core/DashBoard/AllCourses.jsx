...
function AllCourses() {
    ...
    return (
        <div className="min-h-screen bg-gray-100 p-10">
            <h2 className="text-3xl font-bold text-left text-gray-800 mb-8">All Courses</h2>
            ...
            allCourses.map((course, index) => {
                return (
                    <div key={index} >
                         <div key={course._id || index} className="grid  grid-cols-12  gap-4 shadow-lg rounded-xl overflow-hidden p-3">
